...
function AString_Set(var S: AString_Type; const Value: AString_Type): AError; stdcall;

function AString_SetA(var S: AString_Type; Value: AStr): AError; stdcall;
...
function AString_ToUtf8String(const S: AString_Type): UTF8String; stdcall;
