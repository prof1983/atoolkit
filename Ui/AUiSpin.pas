...
{ TSpinButton }
  ...
  private
    ...
    function GetUpGlyph(): Graphics.TBitmap;
    function GetDownGlyph: Graphics.TBitmap;
    procedure SetUpGlyph(Value: Graphics.TBitmap);
    procedure SetDownGlyph(Value: Graphics.TBitmap);
  ...
  published
    ...
    property Ctl3D;
    property DownGlyph: Graphics.TBitmap read GetDownGlyph write SetDownGlyph;
    ...
    property TabOrder;
    property TabStop;
    property UpGlyph: Graphics.TBitmap read GetUpGlyph write SetUpGlyph;
...
function TSpinButton.GetUpGlyph(): Graphics.TBitmap;
begin
  Result := FUpButton.Glyph;
end;

procedure TSpinButton.SetUpGlyph(Value: Graphics.TBitmap);
begin
  if Value <> nil then
...
function TSpinButton.GetDownGlyph(): Graphics.TBitmap;
begin
  Result := FDownButton.Glyph;
end;

procedure TSpinButton.SetDownGlyph(Value: Graphics.TBitmap);
begin
  if Value <> nil then
