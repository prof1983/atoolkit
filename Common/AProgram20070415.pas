...
uses
  ...
  AConsts2, ALogDocumentIntf, ALogDocuments, AProcessImpl, AProgramUtils,
  ATypes, AXmlDocumentImpl, AXmlDocumentIntf;

type //** Основной объект программы
  TProfProgram3 = class(TProfProcess)
  private
  ...
  public
    ...
    class function GetInstance(): TProfProgram3;
  public
...
function TProfProgram3.AddToLog(AGroup: TLogGroupMessage; AType: TLogTypeMessage; const AStrMsg: WideString): Integer;
begin
...
procedure TProfProgram3.AfterConstruction();
begin
  inherited AfterConstruction();
  // ...
end;

constructor TProfProgram3.Create();
begin
  FConfigDocument := nil;
  FLogDocuments := nil;
  FGlbTypeLib := nil;
...
function TProfProgram3.DoAddToLog(AGroup: TLogGroupMessage; AType: TLogTypeMessage; const AStrMsg: WideString): Integer;
begin
...
procedure TProfProgram3.DoCreate();
begin
  inherited DoCreate();
...
procedure TProfProgram3.DoCreated();
var
...
procedure TProfProgram3.DoDestroy();
begin
  DeleteCriticalSection(FCSAddToLog);
  inherited DoDestroy();
end;

function TProfProgram3.DoFinalize(): TProfError;
begin
  Result := inherited DoFinalize();
end;

function TProfProgram3.DoFinalized(): TProfError;
begin
  {if Assigned(FLogDocuments) then
  try
...
function TProfProgram3.DoInitialize(): TProfError;
begin
...
function TProfProgram3.DoInitialized(): TProfError;
begin
  Result := inherited DoInitialized();
end;

class procedure TProfProgram3.DoneProgram();
begin
...
function TProfProgram3.DoStart(): WordBool;
begin
  Result := inherited DoStart();
end;

function TProfProgram3.DoStarted(): WordBool;
begin
  Result := inherited DoStarted();
end;

function TProfProgram3.DoStop(AIsShutDown: WordBool): WordBool;
begin
  Result := inherited DoStop(AIsShutDown);
end;

function TProfProgram3.DoStoped(AIsShutDown: WordBool): WordBool;
begin
  Result := inherited DoStoped(AIsShutDown);
end;

function TProfProgram3.DoTime(): WordBool;
begin
  Result := DoTimer();
end;

function TProfProgram3.DoTimer(): WordBool;
begin
  Result := True;
end;

function TProfProgram3.Finalize(): TProfError;
begin
  Result := inherited Finalize();
end;

procedure TProfProgram3.Free();
begin
  DoDestroy();
...
class function TProfProgram3.GetInstance(): TProfProgram3;
begin
  Result := Prog;
end;

function TProfProgram3.GetIsDemo(): Boolean;
begin
  Result := True;
end;

function TProfProgram3.GetTimeWork(): Integer;
begin
  Result := Round((Now - FDateStart) * 24 * 60);
end;

function TProfProgram3.Initialize(): TProfError;
begin
...
procedure TProfProgram3.SetIsDemo(Value: Boolean);
begin
end;
